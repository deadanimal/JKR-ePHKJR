        ...
        <table class="table table-bordered line-table text-center" style="width: 100%">
          ...
          <tbody>
            ...
            <tr class="text-center">
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofRoofTilesClayTiles" id="Cons_AwRoofRoofTilesClayTi}}
            ...
            <td>{{$gpss_bangunan->AwRoofRoofTilesConcreteTiles}} </td>            
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofRoofTilesConcreteTiles" id="Cons_AwRoofRoofTilesColes"> --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofRoofInsulationRockwool" id="Cons_AwRoofRoofInsulationRockwool"></t       --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofRoofInsulationGlasswool" id="Cons_AwRoofRoofInsulationGlasswool"><         --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofRoofInsulationAlumFoil" id="Cons_AwRoofRoofInsulationAlumFoil"></t       --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofRoofInsulationUndersheeting" id="Cons_AwRoofRoofInsulationUndershe/td>             --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofRoofEavesMetal" id="Cons_AwRoofRoofEavesMetal"></td>                     {{-- <td><input onblur="findTotalAwarded()" type="number" min="0" max="2" class="arkitek_awarded" name="Awarded_AwRoofRoofEavesMetal" id="Awarded_AwRoofRoofEavesMetal"></td>              --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofFascialBoardsFiberCement" id="Cons_AwRoofFascialBoardsFiberCement"           --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofFascialBoardsPlasterboard" id="Cons_AwRoofFascialBoardsPlasterboar             --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofGutterUpvc" id="Cons_AwRoofGutterUpvc"></td>               {{-- <td><input onblur="findTotalAwarded()" type="number" min="0" max="2" class="arkitek_awarded" name="Awarded_AwRoofGutterUpvc" id="Awarded_AwRoofGutterUpvc"></td>              --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofGutterGallron" id="Cons_AwRoofGutterGallron"></td>                    {{-- <td><input onblur="findTotalAwarded()" type="number" min="0" max="2" class="arkitek_awarded" name="Awarded_AwRoofGutterGallron" id="Awarded_AwRoofGutterGallron"></td>              --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofGutterAluminium" id="Cons_AwRoofGutterAluminium"></td>                       {{-- <td><input onblur="findTotalAwarded()" type="number" min="0" max="2" class="arkitek_awarded" name="Awarded_AwRoofGutterAluminium" id="Awarded_AwRoofGutterAluminium"></td>              --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofGutterStainSteel" id="Cons_AwRoofGutterStainSteel"></td>                        {{-- <td><input onblur="findTotalAwarded()" type="number" min="0" max="2" class="arkitek_awarded" name="Awarded_AwRoofGutterStainSteel" id="Awarded_AwRoofGutterStainSteel"></td>             --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofRainPipesUpvc" id="Cons_AwRoofRainPipesUpvc"></td>                    {{-- <td><input onblur="findTotalAwarded()" type="number" min="0" max="2" class="arkitek_awarded" name="Awarded_AwRoofRainPipesUpvc" id="Awarded_AwRoofRainPipesUpvc"></td>              --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofRainPipesGallron" id="Cons_AwRoofRainPipesGallron"></td>                        {{-- <td><input onblur="findTotalAwarded()" type="number" min="0" max="2" class="arkitek_awarded" name="Awarded_AwRoofRainPipesGallron" id="Awarded_AwRoofRainPipesGallron"></td>             --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofTrussTimber" id="Cons_AwRoofTrussTimber"></td>                 {{-- <td><input onblur="findTotalAwarded()" type="number" min="0" max="2" class="arkitek_awarded" name="Awarded_AwRoofTrussTimber" id="Awarded_AwRoofTrussTimber"></td>              --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructed()" type="number" min="0" max="2" class="arkitek_construction" name="Cons_AwRoofTrussMetal" id="Cons_AwRoofTrussMetal"></td>               {{-- <td><input onblur="findTotalAwarded()" type="number" min="0" max="2" class="arkitek_awarded" name="Awarded_AwRoofTrussMetal" id="Awarded_AwRoofTrussMetal"></td>              --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructedWall()" type="number" min="0" max="2" class="prawwall_construction" name="Cons_AwWallWallTypesClay" id="Cons_AwWallWallTypesClay"></td>                        {{-- <td><input onblur="findTotalAwardedWall()" type="number" min="0" max="2" class="prawwall_awarded" name="Awarded_AwWallWallTypesClay" id="Awarded_AwWallWallTypesClay"></td>             --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructedWall()" type="number" min="0" max="2" class="prawwall_construction" name="Cons_AwWallWallTypesFibreCement" id="Cons_AwWallWallTypesFibreCement"></        --}}
            ...
            <tr>
              ...
              <td><input onblur="findTotalConstructedWall()" type="number" min="0" max="2" class="prawwall_construction" name="Cons_AwWallFinishesGlass" id="Cons_AwWallFinishesGlass"></td>                        {{-- <td><input onblur="findTotalAwardedWall()" type="number" min="0" max="2" class="prawwall_awarded" name="Awarded_AwWallFinishesGlass" id="Awarded_AwWallFinishesGlass"></td>            --}}
